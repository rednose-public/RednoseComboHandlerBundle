...
var id        = node.ancestor('.template-grid-container').getAttribute('data-yui3-record'),
        ...
        _yuitest_coverline("build/libbit-grid-select/libbit-grid-select.js", 102);
return modelList.getByClientId(id);
    }
};

// -- Namespace ----------------------------------------------------------------
_yuitest_coverline("build/libbit-grid-select/libbit-grid-select.js", 107);
Y.namespace('Libbit.Grid').Selectable = Selectable;


}, '@VERSION@', {"requires": ["libbit-grid"]});
