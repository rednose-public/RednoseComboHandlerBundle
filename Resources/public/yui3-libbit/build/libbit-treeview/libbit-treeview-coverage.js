...
tree.collapseAll();
    ...
    _renderIcons: function () {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_renderIcons", 180);
...
boundingBox.all('.ygtvlabel').each(function (node) {
            _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "(anonymous 11)", 184);
...
node.setContent(contentNode);
    ...
    _getModelFromLabelNode: function (node) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_getModelFromLabelNode", 206);
...
return node.ancestor('table').getData().model;
    ...
    _getTableElement: function (node) {
        _yuitest_coverfunc("build/libbit-treeview/libbit-treeview.js", "_getTableElement", 213);
