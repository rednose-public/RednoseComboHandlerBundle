...
table.fire('select', { model: model });
        ...
        _yuitest_coverline("build/libbit-datatable-select/libbit-datatable-select.js", 97);
return true;
    },
    ...
    _getModelFromTableRow: function (node) {
        ...
        // for example 'image_1'.
        _yuitest_coverfunc("build/libbit-datatable-select/libbit-datatable-select.js", "_getModelFromTableRow", 103);
...
// -- Namespace ----------------------------------------------------------------
_yuitest_coverline("build/libbit-datatable-select/libbit-datatable-select.js", 114);
