...
Grid = Y.Base.create('grid', Y.Widget,  [ Y.Libbit.Grid.Selectable ], {
    initializer: function (config) {
        _yuitest_coverfunc("build/libbit-grid/libbit-grid.js", "initializer", 139);
_yuitest_coverline("build/libbit-grid/libbit-grid.js", 140);
var data = config.data;
    },

    renderUI : function () {
        _yuitest_coverfunc("build/libbit-grid/libbit-grid.js", "renderUI", 143);
...
this._renderGridItems();
    ...
    _renderGridItems : function() {
        _yuitest_coverfunc("build/libbit-grid/libbit-grid.js", "_renderGridItems", 150);
...
list.each(function (model) {
            _yuitest_coverfunc("build/libbit-grid/libbit-grid.js", "(anonymous 4)", 154);
...
var view = new TemplateView({model: model}),
            ...
            _yuitest_coverline("build/libbit-grid/libbit-grid.js", 158);
...
// -- Namespace ----------------------------------------------------------------
_yuitest_coverline("build/libbit-grid/libbit-grid.js", 173);
